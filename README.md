...
| Типы кроме старта стрима | Смена категории, предстоящий по schedule, конец эфира, Drops (бета: каталог + digest с twitchdrops.app, стрим-алерты до 5 live с приоритетом тега Drops, how-to, claimed) |
...
| Кнопка | Действие |
|---|---|
| **Ловить новые стримы по фильтру?** | Оповещение по игре: 1 категория → сразу фильтры; до 5 новых стримов одним сообщением; частота в **минутах** (**✏️**, по умолчанию 60, 0 = без кулдауна); вкл/выкл, ✏️ и удаление |
