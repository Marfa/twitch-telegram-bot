...
**Редактирование подписки** — меню в том же порядке, что **Дополнительно**: изображение, `⬜️/✅` очистка / заглушка повторов / удалять предыдущие (+ сбой / другие) / кнопка чата / превью / напоминания, игнор / задержка (⭐ где нужно), плюс шаблон, куда слать, сменить тип / копировать.
