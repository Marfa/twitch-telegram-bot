...
| 🎲 Что посмотреть? | Сохранённые фильтры; live → иначе VOD; «Мне повезёт» (live, язык бота → любой, без VOD); ловить новые стримы по фильтру |
...
1. Категории Twitch (до 5) — или **🎲 Мне повезёт** (только live: IGDB random ×5 → язык бота / любой; затем recently released ×5 → язык бота / любой; без VOD; 18+ разрелены)
