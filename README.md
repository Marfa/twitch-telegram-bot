...
| Админка | Рассылка с отложенной отправкой и типом в подписи, DeepL, статистика, обработка выводов |
...
| ↳ 🔔 Системные уведомления | Оповещения об обновлениях, доступности и sync |
...
| Модуль | Назначение |
|---|---|
| `bot.py` | Wizard, меню, уведомления, админ-рассылка, партнёрка, расписание |
