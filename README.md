...
| Продвинутые опции оповещений | Игнор слов, отложенная отправка, заглушка повторов, удаление предыдущих, закрепление до конца стрима |
...
3. **Дополнительно** — чеклист: изображение, очистка названия, игнор ключевых слов ⭐, отложенная отправка ⭐, заглушка повторов ⭐ (начало стрима), удалять предыдущие в канале/группе ⭐, закреплять сообщение до конца стрима ⭐, пользовательзовательские кнопки ⭐/🧪, кнопка чата, 🧪 «Кнопка напоминания» (предстоящий), цвет кнопок (по умолчанию / синий / зелёный / красный — появляется при любой включённой кнопке), превью ссылок (если в шаблоне есть URL); у бесплатных ⭐-опции видны, но не включаются; неотмеченные шаги пропускаются; превью тихо выключается при изображении или кнопке чата
...
Для **предстоящего стрима** после канала и проверки schedule — шаблон и настройки (в бете «Кнопка напоминания» — кнопка со share-ссылкой на оповещение о начале стрима), затем минуты напоминания и куда слать (без отдельного вопроса «нужны ли напоминания»).
...
**Редактирование подписки** — меню в том же порядке, что **Дополнительно**: изображение, `⬜️/✅` очистка / удалять предыдущие (+ сбой / другие) / закреплять сообщение / кнопка чата / 🧪 напомнить о стриме (предстоящий) / превью / напоминания, заглушка повторов и игнор / задержка (шаг минут, ⭐ где нужно), плюс шаблон, куда слать, сменить тип / копировать.
