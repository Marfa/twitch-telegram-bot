...
| Подписки | Список, вкл/выкл, редактирование, удаление |
| Системные оповещения | Вкл/выкл рассылок об обновлениях бота из админки |
| Админка | Рассылка «Обновления бота» с отложенной отправкой, статистика |
...
| 🔔 Настройка системных уведомлений | Вкл/выкл оповещений об обновлениях бота |
| ⚙️ Админка | Рассылка с выбором времени, статистика (только админы) |
...
| Модуль | Назначение |
|---|---|
| `bot.py` | Wizard, меню, уведомления, админ-рассылка |
