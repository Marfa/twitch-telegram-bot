...
**Редактирование подписки** — меню в том же порядке, что **Дополнительно**: изображение, `⬜️/✅` очистка / удалять предыдущие (+ сбой / другие) / кнопка чата / превью / напоминания, заглушка повторов и игнор / задержка (шаг минут, ⭐ где нужно), плюс шаблон, куда слать, сменить тип / копировать.
