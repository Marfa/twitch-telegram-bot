...
| 🎲 Оповещение по игре | В **➕ Новая подписка** (под Drops): сохранённые фильтры; live → иначе VOD; ловить новые стримы по фильтру; в **📋 Мои подписки** — отдельная категория |
...
| Продвинутые опции | На экране **Дополнительно** у всех: изображение, очистка названия, игнор, отложенная отправка, заглушка повторов, удаление предыдущих, **пользовательские кнопки** (⭐ Premium / 🧪 бета), кнопка чата, 🧪 напомнить о стриме (предстоящий), превью ссылок (если URL в шаблоне; выкл при картинке/кнопке чата) |
...
3. **Дополнительно** — чеклист: изображение, очистка названия, игнор ключевых слов ⭐, отложенная отправка ⭐, заглушка повторов ⭐ (начало стрима), удалять предыдущие в канале/группе ⭐, пользовательзовательские кнопки ⭐/🧪, кнопка чата, 🧪 «Кнопка напоминания» (предстоящий), превью ссылок (если в шаблоне есть URL); у бесплатных ⭐-опции видны, но не включаются; неотмеченные шаги пропускаются; превью тихо выключается при изображении или кнопке чата
...
**🎲 Оповещение по игре** (**➕ Новая подписка**, под Drops) — мастер фильтров без «Мне повезёт». Если live нет — недавние VOD. Созданные оповещения — в **📋 Мои подписки** в категории «Оповещение по игре».
...
1. Категории Twitch (одна) — без «Мне повезёт» (оно в **📦 Прочее** → Что посмотреть?); после выбора — сразу следующий шаг
2. Чекбоксы доп. фильтров: теги / зрители / язык / исключить 18+ (неотмеченное = любое)
3. Только для отмеченных — ввод значений (теги, диапазон зрителей, язык)
4. Сохранить фильтр на потом (до 5) или только сейчас

После подборки (или пустого результата):

| Кнопка | Действие |
|---|---|
| **Ловить новые стримы по фильтру?** | Оповещение по игре: 1 категория → сразу фильтры; до 5 новых стримов одним сообщением; **✏️** — теги / зрители / язык / исключить 18+ / частота в **минутах** (по умолчанию 60, 0 = без кулдауна); вкл/выкл и удаление |
...
| ↳ 🎲 Что посмотреть? | Сразу «Мне повезёт»; ещё варианты / фильтры |
...
**Редактирование подписки** — меню в том же порядке, что **Дополнительно**: изображение, `⬜️/✅` очистка / удалять предыдущие (+ сбой / другие) / кнопка чата / 🧪 напомнить о стриме (предстоящий) / превью / напоминания, заглушка повторов и игнор / задержка (шаг минут, ⭐ где нужно), плюс шаблон, куда слать, сменить тип / копировать.
