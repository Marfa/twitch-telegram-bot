...
| 🎲 Что посмотреть? | Несколько сохранённых фильтров на выбор + новый поиск; категории → теги → зрители → язык → 18+ |
...
| 🎲 Что посмотреть? | Выбор сохранённого фильтра / новый поиск |
