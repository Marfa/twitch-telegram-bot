...
| Картинка | Опционально к уведомлению: превью стрима (кадр, обновление 30 мин), видео-превью ⭐ (MP4 ~30 с, обновление 30 мин), обложка игры или своё фото — в начале или в конце подписи; превью ссылок тогда выкл |
...
4. Картинка (если отмечено) — `⬜️/✅ Превью стрима` (кадр эфира Helix, обновление каждые 30 мин), `⬜️/✅ Видео-превью стрима ⭐` (MP4 ~30 с через streamlink/ffmpeg, обновление каждые 30 мин; входит в Продвинутые опции), `⬜️/✅ Использовать обложку игры` или своё изображение и позиция: в начале или в конце
