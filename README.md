...
6. Отложить отправку после начала стрима (да/нет, минуты)
7. Разрешить повторные уведомления (да/нет; при «нет» — минуты заглушки)
8. Напоминания по расписанию Twitch (если у стримера есть schedule)
9. Куда слать: личка / канал / группа или сообщество
10. Для канала или группы — добавьте бота и подтвердите чат
11. Удалять предыдущие сообщения бота при новом стриме? (да/нет)
