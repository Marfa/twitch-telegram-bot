...
| Набор сообщений | **⚙️ Настройки**: постепенный набор текста в пузыре (sendMessageDraft) + «печатает». По умолчанию вкл |
...
| Админка | Рассылка в фоне (без подвисания) с типом в подписи; отложенная — по UTC+3 (MSK), у пользователей со своим UTC — в их локальное время; статистика после всех волн; тип «обновление бота» обновляет главное меню; DeepL, статистика, выводы, **Отменить подписку** (refund Stars по charge_id), **Демо режим** |
...
| ⚙️ Настройки | Премиум, sync, игнорируемые слова, продвинутый режим, набор сообщений, системные уведомления, язык, партнёрка |
...
| ↳ ✍️ Набор сообщений | Постепенный набор текста в пузыре; по умолчанию вкл |
