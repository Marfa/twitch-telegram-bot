...
| 🎲 Оповещение по игре | В **➕ Новая подписка** (под Drops): сохранённые фильтры; live → иначе VOD; «Мне повезёт»; ловить новые стримы по фильтру; в **📋 Мои подписки** — отдельная категория |
...
**🎲 Оповещение по игре** (**➕ Новая подписка**, под Drops) — подбор случайных live-стримов по вашим фильтрам (доступно всем, без Premium). Если live нет — недавние VOD по тем же категориям. Созданные оповещения — в **📋 Мои подписки** в категории «Оповещение по игре».
...
| Кнопка | Действие |
|---|---|
| **Ловить новые стримы по фильтру?** | Оповещение по игре: до 5 новых стримов одним сообщением в формате поиска; настройки по умолчанию, только вкл/выкл и удаление |
...
| 📦 Прочее | Оповещения об ЛС, расписание, чат |
