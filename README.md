...
1. Категории Twitch (до 5) — без «Мне повезёт» (оно в **📦 Прочее** → Что посмотреть?)
...
| Кнопка | Действие |
|---|---|
| **Ловить новые стримы по фильтру?** | Оповещение по игре: до 5 новых стримов одним сообщением в формате поиска; частота 1–24 ч (**✏️**, по умолчанию 1 ч); только вкл/выкл, ✏️ и удаление |
