...
| Подписки | Список, вкл/выкл, редактирование всех полей, удаление; **🧺 Корзина удалённых подписок** — восстановление за 10 дней (30 с Premium); **⏸ Приостановить оповещения** на N дней без паузы подписок; **💬 Чат стримов** — Mini App с embed/fallback (🧪 бета) |
