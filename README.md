...
| Продвинутые опции | На экране **Дополнительно** у всех: изображение, игнор, отложенная отправка, заглушка повторов, удаление предыдущих (⭐ Premium), кнопка чата (бесплатно) |
...
3. **Дополнительно** — чеклист: изображение, игнор ключевых слов ⭐, отложенная отправка ⭐, заглушка повторов ⭐ (начало стрима), удалять предыдущие в канале/группе ⭐, кнопка чата; у бесплатных ⭐-опции видны, но не включаются; неотмеченные шаги пропускаются
...
Шаги 4 / 6 / 7 / 10 — только после отметки на «Дополнительно» (и Premium для ⭐). Кнопка чата и изображение бесплатны.
...
| ⚙️ Настройки | Премиум, sync, игнорируемые слова, набор сообщений, системные уведомления, язык, партнёрка |
