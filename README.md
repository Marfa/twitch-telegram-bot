...
| 🎲 Что посмотреть? | Сохранённые фильтры; live → иначе VOD; «Мне повезёт» (live → VOD по тем же играм); ловить новые стримы по фильтру |
...
**🎲 Что посмотреть?** — подбор случайных live-стримов по вашим фильтрам (доступно всем, без Premium). Если live нет — недавние VOD по тем же категориям.
...
1. Категории Twitch (до 5) — или **🎲 Мне повезёт** (IGDB random ×5 → live язык бота / любой; recently released ×5 → live; если пусто — VOD по тем же играм; 18+ разрелены)
...
**📅 Создать расписание** в главном меню (доступно всем) — мастер текста на следующую неделю (с ближайшего понедельника по воскресенье):
...
3. Перед созданием слотов все текущие сегменты расписания на канале удаляются
...
| ⚙️ Настройки | Премиум, sync, игнорируемые слова, оповещения об ЛС, продвинутый режим, системные уведомления, язык, партнёрка |
