...
| Картинка | Опционально к уведомлению: превью стрима (кадр эфира), обложка игры или своё фото — в начале или в конце подписи; превью ссылок тогда выкл |
...
4. Картинка (если отмечено) — `⬜️/✅ Превью стрима` (кадр эфира с Twitch Helix, без хранения в БД), `⬜️/✅ Использовать обложку игры` (категория с Twitch) или своё изображение и позиция: в начале или в конце
