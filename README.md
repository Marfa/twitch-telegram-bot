...
| Подписки | Список, вкл/выкл, редактирование всех полей, удаление; **🧺 Корзина удалённых подписок** — восстановление за 10 дней (30 с Premium); **⏸ Приостановить оповещения** на N дней без паузы подписок (🧪 бета); **💬 Чат стримов** — Mini App с embed/fallback (🧪 бета) |
...
| Премиум | Триал 7 дней (после окончания — пауза оповещений и уведомление в ЛС); Stars месяц/год/lifetime; à la carte (продвинутый режим, история за 60 дней, корзина 30 дней; чат стримов — после публичного релиза беты); саб Twitch (`PREMIUM_TWITCH_LOGIN`); разовый **Премиум-канал** для стримеров (`PREMIUM_CHANNEL_STARS`) |
