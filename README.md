...
| Подписки | Список с пагинацией, вкл/выкл, редактирование всех полей, удаление; **Поделиться оповещением** (🧪 бета) — deep link с копией настроек; **🧺 Корзина удалённых подписок** — восстановление за 10 дней (30 с Premium); **⏸ Приостановить оповещения** на N дней без паузы подписок; **💬 Чат стримов** — Mini App с embed/fallback (🧪 бета) |
...
В **📋 Управление подписками** есть **⏸ Приостановить оповещения**: указать число дней (0 — снова включить). Подписки остаются активными; бот не доставляет стримовые и системные сообщения до указанной даты.
...
| 📋 Управление подписками | Список, редактирование, удаление; **⏸ Приостановить оповещения** |
