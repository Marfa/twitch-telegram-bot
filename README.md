...
| 🎁 Раздачи игр | Бета: **➕ Новая подписка** → под «Выход релизов»; магазины + платформы (GamerPower + IsThereAnyDeal); дайджест раз в сутки (100% free); обогащение IGDB; «Свежие раздачи» после первой рассылки |
