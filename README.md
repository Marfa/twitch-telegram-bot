...
| Премиум | Триал 7 дней; Stars месяц/год/lifetime; à la carte (продвинутый режим, история за 60 дней; корзина / чат стримов — после публичного релиза соответствующих бет); саб Twitch (`PREMIUM_TWITCH_LOGIN`) |
