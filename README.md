...
| Расписание стримов | **📅 Управление расписанием** в **📦 Прочее**: недельный мастер, **поправить слоты на день**, **режим отпуска**, **Часовой пояс** (UTC); публикация / отпуск на Twitch — **Premium** |
...
| **Поправить слоты на день** | Выбрать день → добавить/править слоты тем же текстом; при синхронизации на Twitch очищаются слоты только этого дня |
| **Режим отпуска** | Если отпуск уже активен — выйти или поправить даты; иначе календарь начала/конца → автовыход Да/Нет → Vacation Mode на Twitch (**Premium**); оповещения «Предстоящий стрим» в период отпуска не уходят |
...
| ↳ 📅 Управление расписанием | Неделя, день, отпуск, часовой пояс; синк на Twitch — Premium |
