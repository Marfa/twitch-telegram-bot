...
Еженедельный отчёт админам (пн 10:00 МСК): новые пользователи + платившие Stars за неделю + активные триалы; в скобках — изменение к прошлой такой рассылке. 1-го числа в 10:00 МСК — то же за предыдущий календарный месяц.
