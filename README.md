...
| Обложка | Опционально к уведомлению: превью стрима (кадр, 30 мин), Gif-превью ⭐ (MP4 ~30 с автоплей, 30 мин), видео-превью ⭐ (MP4 ~30 с без звука, 30 мин), обложка игры или своё фото — в начале или в конце подписи; превью ссылок тогда выкл |
...
| Продвинутые опции оповещений | Игнор слов, отложенная отправка, заглушка повторов, удаление предыдущих, закрепление до конца стрима, мультистрим (предпочитать GG/VK/YouTube онлайн; через 15 мин слать всё равно), отмена стрима по расписанию |
...
4. Обложка (если отмечено) — `⬜️/✅ Превью стрима` (кадр эфира Helix, обновление каждые 30 мин), `⬜️/✅ Gif-превью стрима ⭐` (MP4 ~30 с как анимация с автоплеем, обновление каждые 30 мин; Продвинутые опции), `⬜️/✅ Видео-превью стрима ⭐` (MP4 ~30 с как видео без звука, обновление каждые 30 мин; Продвинутые опции), `⬜️/✅ Использовать обложку игры` или своё фото и позиция: в начале или в конце
