...
# POSHTOG_* is the VPS env name already in use; POSTHOG_* is the spelled form.
POSTHOG_PERSONAL_API_KEY = (
    os.getenv("POSHTOG_API_KEY_PERSONAL", "").strip()
    or os.getenv("POSTHOG_API_KEY_PERSONAL", "").strip()
)
