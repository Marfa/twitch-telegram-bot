...
| Alert types beyond live start | Category change, upcoming (schedule), stream end, Drops (beta: catalog, digest, stream alerts up to 5 live with 1h cooldown, claimed) |
