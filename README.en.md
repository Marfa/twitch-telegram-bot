...
| Alert types beyond live start | Category change, upcoming (schedule), stream end, Drops (beta: catalog + digest from twitchdrops.app, stream alerts up to 5 live with Drops-tag priority, how-to, claimed) |
