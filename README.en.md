...
| Alert types beyond live start | Category change, upcoming (schedule), stream end, Drops (beta: catalog, digest, stream alerts up to 5 live on subscribe then new-only, claimed) |
