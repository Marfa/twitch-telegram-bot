...
class Database(Protocol):
    ...
    def get_premium_purchase_by_charge(self, charge_id: str) -> Any | None: ...
    ...
    def get_global_ignore_igdb(self, user_id: int) -> list[dict[str, Any]]: ...

    def set_global_ignore_igdb(
    ...
    def list_giveaways_catalog(self) -> list[Any]: ...
