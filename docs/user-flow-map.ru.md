...
Не-live типы и шаги delay/ignore/repeat/delete — через Premium / gate. Простой режим (продвинутый выкл) пропускает ignore / delay / repeat / delete. В продвинутом режиме после картинки — экран «Дополнительно» с тумблерами; неотмеченные шаги пропускаются.
...
| | |
|---|---|
| Текст | Отметьте нужные опции |
| Inline | `⬜️/✅ Игнор` · `⬜️/✅ Задержка` · `⬜️/✅ Повторы` (live) · `⬜️/✅ Удалять предыдущие` · `Далее` |
| Далее | Только отмеченные шаги ниже |
