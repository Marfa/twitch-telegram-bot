...
| `⚙️ Настройки` | Настройки (§8) |
| `🐛 Сообщить о проблеме` | Фидбек (§10) |
...
|---|---|---|
| 1/5 | `Что посмотреть — шаг 1/5` | Текст категории; Inline `Готово` · `Очистить список`; Reply `Отмена` |
...
| Результат | `Сейчас в эфире:` / пусто | `Ещё варианты` · `Фильтры / новый поиск` |
