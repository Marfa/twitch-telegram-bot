...
| Reply | Экран |
|---|---|
| `⭐ Премиум` | Тарифы / триал / marfapr / Премиум-канал / функции / оферта |
...
`Пробный период` · `Создать подписку на marfapr` · `Премиум канал (для стримеров)` → Подтвердить (Twitch OAuth) → `Оплатить {stars} ⭐` · `Подписка на месяц — {stars} ⭐` · год · пожизненная · `Оплатить только нужные функции` · `Купленные подписки` · `Оферта`
