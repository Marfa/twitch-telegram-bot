...
| `📢 В канал` | Инструкция → `@username` / `https://t.me/…` / ID / переслать → delete_old |
| `💬 В группу или сообщество` | То же: ссылка на группу `https://t.me/название`, тема `t.me/c/…/N`, `@username`, ID, переслать |
