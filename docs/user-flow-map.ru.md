...
`Мне повезёт`: индикатор «Ищем стримы…»; 5 игр IGDB random (с категорией Twitch) → язык бота, иначе любой; затем 5 recently released → язык бота, иначе любой; только live (без VOD); 18+ включены.
