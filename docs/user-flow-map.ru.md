...
`📝 Шаблон…` · `🖼 Добавить/Обновить` · `🗑 Удалить изображение` · `🚫 Игнорировать…` · `🔗 Превью…` · `⏱ Задержка…` · `🔁 Повторные…` · `📅 Напоминания…` · `📍 Куда…` · `🗑 Удалять старые` · … · **`🔄 Сменить категорию`** · **`📋 Скопировать`** · **`📋🔄 Скопировать и сменить категорию`**

| Пункт | Поведение |
|---|---|
| `🔄 Сменить категорию` | Выбор другого типа оповещения → несовместимые настройки сбрасываются, недостающие — по умолчанию · `Отменить` — без изменений |
| `📋 Скопировать` | Копия со всеми настройками (лимит подписок / активных учитывается) |
| `📋🔄 Скопировать и сменить категорию` | Сначала выбор типа для копии · `Отменить` — копия **не** создаётся |
