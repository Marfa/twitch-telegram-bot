...
_EXTRA_CALLBACKS: tuple[tuple[str, str], ...] = (
    ...
    ("gv_fresh", "gv:fresh"),
    ("gv_watch", "gv:watch"),
    ("gv_details", "gv:details"),
    ("gv_more", "gv:more:5"),
    ("gv_streams", "gv:streams:42"),
    ("gv_stores_toggle", "gv:stores:toggle:steam"),
    ...
    ("edit_button_style", f"edit_f:{_SAMPLE_SUB}:button_style"),
    ("edit_set_button_style", f"edit_set:{_SAMPLE_SUB}:button_style:primary"),
    ("advopt_style", "advopt:style:success"),
    ...
    ("stream_sched_vacation", "stream_sched:mode:vacation"),
    ("stream_sched_vac_manage", "stream_sched:vac_manage:exit"),
    ("stream_sched_vac_auto", "stream_sched:vac_auto:1"),
    ("vac_month", "vac:month:2026-09"),
    ("vac_date", "vac:date:0"),
    ...
    samples: list[tuple[str, Any, dict[str, Any]]] = [
        ...
        (
            ...
            advanced_options_keyboard,
            {
                ...
                "want_buttons": True,
                "show_buttons": True,
                "show_live_remind": False,
                "show_top_donations": False,
            },
        ),
        (
            "advanced_options_upcoming",
            advanced_options_keyboard,
            {
                "lang": loc,
                "want_image": False,
        ...
        ("stream_sched_vacation_auto", stream_schedule_vacation_auto_keyboard, {"lang": loc}),
        ("stream_sched_vacation_active", stream_schedule_vacation_active_keyboard, {"lang": loc}),
